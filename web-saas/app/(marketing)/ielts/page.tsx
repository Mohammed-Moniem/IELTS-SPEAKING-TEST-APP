  ...
  return (
    <div className="space-y-10 lg:space-y-14">
      ...
      {isMotionVariant ? (
        ...
        <section className="relative overflow-hidden rounded-[2rem] border border-violet-300/45 bg-gradient-to-br from-violet-700 via-violet-600 to-purple-600 p-10 lg:p-14 text-white">
          ...
          <div className="relative z-10 max-w-3xl space-y-4">
            ...
            <h1 className="text-4xl lg:text-5xl font-extrabold leading-tight">IELTS Preparation Guides by Module and Score Goal</h1>
