...
export default async function GuideDetailPage({ params }: GuidePageProps) {
  ...
  if (moduleSegment === 'offers' || moduleSegment === 'membership') {
    notFound();
  }
  ...
  const relatedGuides = detail.related
  ...
  return (
    <div className="space-y-6">
      ...
      {isMotionVariant ? (
        ...
        <section className="marketing-hero-surface space-y-4 rounded-2xl p-8 text-white">
