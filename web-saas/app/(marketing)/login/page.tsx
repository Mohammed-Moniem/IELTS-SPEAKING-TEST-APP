    ...
    <div className="mx-auto max-w-md w-full">
      ...
      <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-8 space-y-6 shadow-sm">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
          No account yet? <Link href={nextParam ? `/register?next=${encodeURIComponent(nextParam)}` : '/register'} className="text-violet-600 dark:text-violet-400 hover:underline font-semibold">Create one now</Link>
        </p>
      </div>
    </div>
  );
