      ...
      <div className="space-y-6">
        {isMotionVariant ? (
          <MarketingPageHero
            variant="compact"
            animated
            badge={{ icon: 'mark_email_read', text: 'Verification' }}
            title="Verifying your email"
            description="We are confirming your email address. This takes just a moment."
          />
        ) : null}
      ...
      <div className="space-y-6">
        {isMotionVariant ? (
          <MarketingPageHero
            variant="compact"
            animated
            badge={{ icon: 'verified', text: 'Verification' }}
            title="Email verified"
            description="Your account is now confirmed and ready to use."
          />
        ) : null}
        <div className="mx-auto max-w-md w-full">
          <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-8 space-y-6 shadow-sm text-center">
    ...
    <div className="space-y-6">
      {isMotionVariant ? (
        <MarketingPageHero
          variant="compact"
          animated
          badge={{ icon: 'error', text: 'Verification' }}
