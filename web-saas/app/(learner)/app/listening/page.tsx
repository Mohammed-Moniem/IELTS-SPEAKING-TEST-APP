...
export default function ListeningPage() {
  ...
  const submitTest = async () => {
    ...
    try {
      ...
      const submitted = await apiRequest<ObjectiveAttempt>(`/listening/tests/${attemptId}/submit`, {
        method: 'POST',
  ...
  return (
    <section className="section-wrap">
      <div className="panel hero-panel stack">
        <span className="tag">Listening module</span>
        <h1>Listening tests with audio-aware scoring pipeline</h1>
        <p className="subtitle">Start attempts, submit answers, and track normalized band performance.</p>
      </div>
        ...
        <div className="stack">
          <div className="panel stack">
            ...
            {test.audioUrl ? (
              ...
              <p className="small">No audio URL available for this test. Use transcript fallback below.</p>
            )}
            {test.transcript ? <p className="small">Transcript preview: {test.transcript.slice(0, 220)}...</p> : null}
