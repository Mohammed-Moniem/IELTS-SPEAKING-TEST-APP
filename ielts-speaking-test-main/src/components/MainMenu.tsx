      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Welcome back, <span className="font-medium text-foreground">{userName}</span>! Choose your learning approach: practice with specific topics or take a full AI-driven test simulation.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {/* Practice Mode */}
          <Card className="glass-card p-8 cursor-pointer group" 
          ...
          <Card className="glass-card p-8 cursor-pointer group"
            ...
            <div className="text-center space-y-6">
              ...
              <div>
                ...
                <div className="flex justify-center gap-2 mb-6">
                  <Badge variant="outline" className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-full">
                    <Clock size={16} />
                    11-14 minutes
                  </Badge>
                </div>
              ...
              <Button variant="outline" className="w-full modern-button h-12 text-base font-medium rounded-lg">
                Take Full Test
              </Button>
            </div>
          </Card>
        ...
        <Card className="glass-card p-8">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="space-y-3">
              ...
              <h3 className="font-semibold text-foreground text-base">Part 1</h3>
            ...
            <div className="space-y-3">
              ...
              <h3 className="font-semibold text-foreground text-base">Part 2</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="space-y-3">
              ...
              <h3 className="font-semibold text-foreground text-base">Part 3</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
