...
export type PasswordResetConfirmFormValues = yup.InferType<
  typeof passwordResetConfirmSchema
>;

// ==================== UPGRADE GUEST SCHEMA ====================
export const upgradeGuestSchema = yup.object().shape({
  email: yup
    .string()
    .required("Email is required")
    .email("Please enter a valid email address")
...
export type UpgradeGuestFormValues = yup.InferType<typeof upgradeGuestSchema>;
