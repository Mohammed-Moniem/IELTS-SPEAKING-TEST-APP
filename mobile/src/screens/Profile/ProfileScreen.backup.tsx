...
const COUNTRY_CODES = [
  ...
  { label: "🇨🇿 Czech Republic (+420)", value: "+420", flag: "🇨🇿", code: "+420" },
...
export const ProfileScreen: React.FC = () => {
  ...
  const updateSocialProfileMutation = useMutation({
    ...
    onError: (error: any) => {
      Alert.alert(
        "Update failed",
        error?.message ?? "Unable to update social profile."
      );
    },
  });
          ...
          >
            <View style={countryCodeModalStyles.content}>
              <View style={countryCodeModalStyles.header}>
                <Text style={countryCodeModalStyles.title}>Select Country Code</Text>
                ...
                {COUNTRY_CODES.map((country) => (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      country.value === countryCode && countryCodeModalStyles.selectedOption
                    ]}
                    onPress={() => {
          ...
          <Button
            ...
            onPress={() =>
              updateProfileMutation.mutate({
                ...
                phone: countryCode + profileForm.phone, // Combine country code + phone
              })
            }
        ...
        {subscriptionQuery.data ? (
          <View style={styles.subscriptionCard}>
            <View style={styles.subscriptionHeader}>
              ...
              {usageQuery.data?.data?.plan && (
                <Text style={styles.usagePlan}>
                  Usage: {usageQuery.data.data.plan.toUpperCase()}
                </Text>
              )}
            </View>
...
const countryCodeModalStyles = StyleSheet.create({
  overlay: {
    flex: 1,
    backgroundColor: "rgba(0,0,0,0.5)",
    justifyContent: "center",
